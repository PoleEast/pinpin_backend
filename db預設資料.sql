...
VALUES 
  ...
  ('背包客', '自由靈活的冒險旅行，強調探索與自助', 'fa-hiking', 'brown'),
  ('家庭旅遊', '適合全家出遊，提供親子友善的活動與住宿', 'fa-users', 'blue'),
  ('單人旅行', '獨自探索，享受個人自由與獨立', 'fa-user', 'orange'),
  ('團體旅行', '組織性強的團體出遊，共享行程和體驗', 'fa-people-group', 'purple'),
